...
function SendPingDetails(status) {
	...
	setTimeout(function () {
		var pc = (localStorage.pc == undefined || localStorage.pc == "" || localStorage.pc == null) ? "BG00" : localStorage.pc;
...
chrome.browserAction.onClicked.addListener(function (tab) {
	var redirectURL = "https://www.bing.com/?pc=" + defaultPC;
	if (localStorage["pc"]) {
		redirectURL = "https://www.bing.com/?pc=" + localStorage["pc"];
	}
...
chrome.webRequest.onBeforeRequest.addListener(function (details) {
    ...
    function getSearchUrl(queryString, pc) {
        return "https://www.bing.com/search?EID=MBHSC&form=BGGCDF&pc=" + pc + "&q=" + queryString;
    }

    function getHomepageUrl(pc) {
        return "https://www.bing.com/?pc=" + pc + "&DPC=" + pc;
    }
    ...
    urls: ["*://www.bing.com/search?EID=MBHSC&form=BGGCMF&pc=BG00*", "*://www.bing.com/?pc=BG00"] // List of URLs
